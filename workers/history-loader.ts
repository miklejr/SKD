// Скрипт для загрузки исторических котировок с MOEX ISS API
// Загружает дневные котировки с 2020 года до сегодня и сохраняет в Redis
...
async function main() {
  ...
  console.log(`📊 Обработано тикеров: ${TICKERS.length}`);
}
